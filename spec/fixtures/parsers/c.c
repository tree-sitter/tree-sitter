...
static const TSParseAction *ts_parse_actions[STATE_COUNT][SYMBOL_COUNT] = {
    ...
    [13] = {
        ...
        [anon_sym_RBRACE] = ACTIONS(SHIFT(115)),
    ...
    [36] = {
        ...
        [anon_sym_LBRACK] = ACTIONS(SHIFT(106)),
        [anon_sym_LPAREN] = ACTIONS(SHIFT(107)),
    ...
    [106] = {
        ...
        [sym_math_expression] = ACTIONS(SHIFT(76)),
        [sym_call_expression] = ACTIONS(SHIFT(76)),
        [anon_sym_RBRACK] = ACTIONS(SHIFT(104)),
        [sym_string] = ACTIONS(SHIFT(76)),
        [sym_identifier] = ACTIONS(SHIFT(76)),
        [sym_number] = ACTIONS(SHIFT(76)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    ...
    [112] = {
        [anon_sym_RBRACK] = ACTIONS(SHIFT(110)),
        [anon_sym_LPAREN] = ACTIONS(SHIFT(77)),
        [anon_sym_STAR] = ACTIONS(SHIFT(78)),
        [anon_sym_PLUS] = ACTIONS(SHIFT(79)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    ...
    [118] = {
        ...
        [anon_sym_COMMA] = ACTIONS(SHIFT(238)),
    ...
    [120] = {
        ...
        [anon_sym_LBRACK] = ACTIONS(SHIFT(127)),
        [anon_sym_LPAREN] = ACTIONS(SHIFT(128)),
    ...
    [127] = {
        ...
        [sym_math_expression] = ACTIONS(SHIFT(76)),
        [sym_call_expression] = ACTIONS(SHIFT(76)),
        [anon_sym_RBRACK] = ACTIONS(SHIFT(125)),
        [sym_string] = ACTIONS(SHIFT(76)),
        [sym_identifier] = ACTIONS(SHIFT(76)),
        [sym_number] = ACTIONS(SHIFT(76)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    ...
    [133] = {
        [anon_sym_RBRACK] = ACTIONS(SHIFT(131)),
        [anon_sym_LPAREN] = ACTIONS(SHIFT(77)),
        [anon_sym_STAR] = ACTIONS(SHIFT(78)),
        [anon_sym_PLUS] = ACTIONS(SHIFT(79)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    ...
    [135] = {
        ...
        [anon_sym_LPAREN] = ACTIONS(SHIFT(225)),
        [anon_sym_STAR] = ACTIONS(SHIFT(40)),
    ...
    [139] = {
        ...
        [anon_sym_short] = ACTIONS(SHIFT(9)),
        [anon_sym_struct] = ACTIONS(SHIFT(10)),
        [anon_sym_RBRACE] = ACTIONS(SHIFT(206)),
        [anon_sym_const] = ACTIONS(SHIFT(11)),
        [anon_sym_restrict] = ACTIONS(SHIFT(11)),
        [anon_sym_volatile] = ACTIONS(SHIFT(11)),
    ...
    [142] = {
        ...
        [anon_sym_STAR] = ACTIONS(SHIFT(190)),
        [anon_sym_PLUS] = ACTIONS(SHIFT(191)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    },
    [143] = {
    ...
    [146] = {
        ...
        [anon_sym_COMMA] = ACTIONS(SHIFT(187)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    },
    [147] = {
    ...
    [148] = {
        ...
        [anon_sym_COMMA] = ACTIONS(REDUCE(sym_initializer, 1)),
        [anon_sym_LPAREN] = ACTIONS(SHIFT(175)),
        [anon_sym_STAR] = ACTIONS(SHIFT(176)),
        [anon_sym_PLUS] = ACTIONS(SHIFT(177)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    },
    [149] = {
    ...
    [153] = {
        ...
        [anon_sym_EQ] = ACTIONS(SHIFT(155)),
        [anon_sym_LBRACK] = ACTIONS(SHIFT(156)),
        [anon_sym_DOT] = ACTIONS(SHIFT(157)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    },
    [154] = {
        [anon_sym_EQ] = ACTIONS(SHIFT(163)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    },
    [155] = {
    ...
    [160] = {
        [anon_sym_RBRACK] = ACTIONS(SHIFT(161)),
        [anon_sym_LPAREN] = ACTIONS(SHIFT(77)),
        [anon_sym_STAR] = ACTIONS(SHIFT(78)),
        [anon_sym_PLUS] = ACTIONS(SHIFT(79)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    ...
    [170] = {
        ...
        [sym_call_expression] = ACTIONS(SHIFT(149)),
        [anon_sym_LBRACE] = ACTIONS(SHIFT(150)),
        [anon_sym_RBRACE] = ACTIONS(SHIFT(173)),
        [anon_sym_LBRACK] = ACTIONS(SHIFT(151)),
        [anon_sym_DOT] = ACTIONS(SHIFT(152)),
        [sym_string] = ACTIONS(SHIFT(149)),
        [sym_identifier] = ACTIONS(SHIFT(149)),
    ...
    [202] = {
        [anon_sym_SEMI] = ACTIONS(SHIFT(209)),
        [anon_sym_LPAREN] = ACTIONS(SHIFT(210)),
        [anon_sym_STAR] = ACTIONS(SHIFT(211)),
        [anon_sym_PLUS] = ACTIONS(SHIFT(212)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    },
    [203] = {
        [anon_sym_SEMI] = ACTIONS(REDUCE(sym_expression, 1)),
    ...
    [205] = {
        [anon_sym_RBRACE] = ACTIONS(SHIFT(208)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    },
    [206] = {
    ...
    [223] = {
        ...
        [anon_sym_SEMI] = ACTIONS(REDUCE(sym_declarator, 1)),
        [anon_sym_EQ] = ACTIONS(REDUCE(sym_declarator, 1)),
        [anon_sym_LBRACK] = ACTIONS(SHIFT(230)),
    ...
    [230] = {
        ...
        [sym_math_expression] = ACTIONS(SHIFT(76)),
        [sym_call_expression] = ACTIONS(SHIFT(76)),
        [anon_sym_RBRACK] = ACTIONS(SHIFT(228)),
        [sym_string] = ACTIONS(SHIFT(76)),
        [sym_identifier] = ACTIONS(SHIFT(76)),
        [sym_number] = ACTIONS(SHIFT(76)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    ...
    [233] = {
        [anon_sym_RPAREN] = ACTIONS(SHIFT(235)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    },
    [234] = {
        [aux_sym_declaration_repeat1] = ACTIONS(REDUCE(sym__direct_declarator, 4)),
    ...
    [236] = {
        [anon_sym_RBRACK] = ACTIONS(SHIFT(234)),
        [anon_sym_LPAREN] = ACTIONS(SHIFT(77)),
        [anon_sym_STAR] = ACTIONS(SHIFT(78)),
        [anon_sym_PLUS] = ACTIONS(SHIFT(79)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    ...
    [237] = {
        [anon_sym_SEMI] = ACTIONS(SHIFT(242)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    },
    [238] = {
    ...
    [257] = {
        [anon_sym_SEMI] = ACTIONS(SHIFT(259)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    },
    [258] = {
    ...
    [268] = {
        [anon_sym_SEMI] = ACTIONS(SHIFT(269)),
        [sym_comment] = ACTIONS(SHIFT_EXTRA()),
    },
    [269] = {
