...
static const TSParseAction ts_parse_actions[STATE_COUNT][SYMBOL_COUNT] = {
    ...
    [6] = {
        ...
        [sym__line_break] = SHIFT_EXTRA(),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_program_repeat0] = SHIFT(430),
    ...
    [7] = {
        ...
        [sym__line_break] = SHIFT_EXTRA(),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_program_repeat1] = SHIFT(429),
        [aux_sym_STR_type] = SHIFT(12),
        [aux_sym_STR_var] = SHIFT(13),
        [aux_sym_STR_func] = SHIFT(14),
    },
    ...
    [9] = {
        ...
        [sym__line_break] = SHIFT_EXTRA(),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_program_repeat1] = SHIFT(428),
        [aux_sym_STR_type] = SHIFT(12),
        [aux_sym_STR_var] = SHIFT(13),
        [aux_sym_STR_func] = SHIFT(14),
    },
    ...
    [61] = {
        ...
        [sym__identifier] = SHIFT(16),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_interface_type_repeat0] = SHIFT(110),
    ...
    [81] = {
        ...
        [sym__identifier] = SHIFT(46),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym__func_signature_repeat0] = SHIFT(83),
        [aux_sym_STR_STAR] = SHIFT(48),
        [aux_sym_STR_map] = SHIFT(49),
        [aux_sym_STR_LBRACK] = SHIFT(50),
        [aux_sym_STR_struct] = SHIFT(51),
    ...
    [111] = {
        ...
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_struct_type_repeat0] = SHIFT(114),
    ...
    [117] = {
        ...
        [sym__identifier] = SHIFT(113),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_struct_type_repeat0] = SHIFT(162),
    ...
    [125] = {
        ...
        [sym__identifier] = SHIFT(16),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_interface_type_repeat0] = SHIFT(126),
    ...
    [129] = {
        ...
        [sym__identifier] = SHIFT(113),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_struct_type_repeat0] = SHIFT(130),
    ...
    [144] = {
        ...
        [sym__identifier] = SHIFT(16),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_interface_type_repeat0] = SHIFT(145),
    ...
    [148] = {
        ...
        [sym__identifier] = SHIFT(113),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_struct_type_repeat0] = SHIFT(149),
    ...
    [197] = {
        ...
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_block_statement_repeat0] = SHIFT(204),
    ...
    [199] = {
        ...
        [sym_number] = SHIFT(202),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_block_statement_repeat0] = SHIFT(382),
        [aux_sym_STR_var] = SHIFT(206),
    ...
    [203] = {
        [sym__line_break] = REDUCE(sym_expression, 1),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_declaration_statement_repeat0] = SHIFT(370),
        [aux_sym_STR_LPAREN] = REDUCE(sym_expression, 1),
        [aux_sym_STR_SEMI] = REDUCE(sym_expression, 1),
        [aux_sym_STR_STAR] = REDUCE(sym_expression, 1),
    ...
    [222] = {
        ...
        [sym_number] = SHIFT(202),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_block_statement_repeat0] = SHIFT(235),
        [aux_sym_STR_var] = SHIFT(206),
    ...
    [238] = {
        [sym__line_break] = SHIFT_EXTRA(),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_call_expression_repeat0] = SHIFT(244),
    ...
    [259] = {
        [sym__line_break] = SHIFT_EXTRA(),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_call_expression_repeat0] = SHIFT(260),
        [aux_sym_STR_LPAREN] = SHIFT(245),
    ...
    [270] = {
        ...
        [sym_number] = SHIFT(202),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_block_statement_repeat0] = SHIFT(271),
        [aux_sym_STR_var] = SHIFT(206),
    ...
    [302] = {
        [sym__line_break] = SHIFT_EXTRA(),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_call_expression_repeat0] = SHIFT(304),
        [aux_sym_STR_LPAREN] = SHIFT(245),
    ...
    [307] = {
        ...
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_return_statement_repeat0] = SHIFT(314),
    ...
    [328] = {
        ...
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_return_statement_repeat0] = SHIFT(329),
        [aux_sym_STR_LPAREN] = SHIFT(315),
    ...
    [331] = {
        [sym__line_break] = SHIFT_EXTRA(),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_call_expression_repeat0] = SHIFT(333),
        [aux_sym_STR_LPAREN] = SHIFT(245),
    ...
    [348] = {
        ...
        [sym__identifier] = SHIFT(16),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_interface_type_repeat0] = SHIFT(349),
    ...
    [352] = {
        ...
        [sym__identifier] = SHIFT(113),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_struct_type_repeat0] = SHIFT(353),
    ...
    [375] = {
        [sym__line_break] = SHIFT_EXTRA(),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_declaration_statement_repeat0] = SHIFT(377),
        [aux_sym_STR_COMMA] = SHIFT(371),
    ...
    [403] = {
        ...
        [sym__identifier] = SHIFT(16),
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_interface_type_repeat0] = SHIFT(404),
    ...
    [421] = {
        ...
        [sym_comment] = SHIFT_EXTRA(),
        [aux_sym_imports_block_repeat0] = SHIFT(423),
