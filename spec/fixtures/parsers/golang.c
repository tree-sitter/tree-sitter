...
static const TSNodeType ts_node_types[SYMBOL_COUNT] = {
    ...
    [aux_sym_package] = TSNodeTypeConcrete,
    [aux_sym_import] = TSNodeTypeConcrete,
    [aux_sym_LPAREN] = TSNodeTypeConcrete,
    [aux_sym_RPAREN] = TSNodeTypeConcrete,
    [aux_sym_type] = TSNodeTypeConcrete,
    [aux_sym_SEMI] = TSNodeTypeConcrete,
    [aux_sym_var] = TSNodeTypeConcrete,
    [aux_sym_EQ] = TSNodeTypeConcrete,
    [aux_sym_func] = TSNodeTypeConcrete,
    [aux_sym_LBRACE] = TSNodeTypeConcrete,
    [aux_sym_RBRACE] = TSNodeTypeConcrete,
    [aux_sym_STAR] = TSNodeTypeConcrete,
    [aux_sym_map] = TSNodeTypeConcrete,
    [aux_sym_LBRACK] = TSNodeTypeConcrete,
    [aux_sym_RBRACK] = TSNodeTypeConcrete,
    [aux_sym_struct] = TSNodeTypeConcrete,
    [aux_sym_interface] = TSNodeTypeConcrete,
    [aux_sym_return] = TSNodeTypeConcrete,
    [aux_sym_COMMA] = TSNodeTypeConcrete,
    [aux_sym_COLON_EQ] = TSNodeTypeConcrete,
    [aux_sym_for] = TSNodeTypeConcrete,
    [aux_sym_range] = TSNodeTypeConcrete,
    [aux_sym_if] = TSNodeTypeConcrete,
    [aux_sym_else] = TSNodeTypeConcrete,
    ...
    [aux_sym_PIPE_PIPE] = TSNodeTypeConcrete,
    [aux_sym_AMP_AMP] = TSNodeTypeConcrete,
    [aux_sym_EQ_EQ] = TSNodeTypeConcrete,
    [aux_sym_LT_EQ] = TSNodeTypeConcrete,
    [aux_sym_LT] = TSNodeTypeConcrete,
    [aux_sym_GT_EQ] = TSNodeTypeConcrete,
    [aux_sym_GT] = TSNodeTypeConcrete,
    [aux_sym_BANG] = TSNodeTypeConcrete,
