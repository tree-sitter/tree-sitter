            ...
            missing_path_else(
                ...
                |path| {
                    ...
                    if !contents.contains("PyModuleDef_Init") {
                        info!("Updating bindings/python/tree_sitter_{}/binding.c", language_name.to_snake_case());
                        contents = contents
                ...
                missing_path_else(
                    ...
                    |path| {
                        ...
                        if !contents.contains("Parser(Language(") {
                            info!("Updating bindings/python/tests/test_binding.py");
                            contents = contents
