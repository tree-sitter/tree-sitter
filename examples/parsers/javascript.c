...
PARSE_TABLE = {
    ...
    [201] = {    
        [ts_aux_sym_token1] = SHIFT(202),    
        [ts_aux_sym_token2] = SHIFT(207),    
    ...
    [207] = {    
        ...
        [ts_aux_sym_token3] = SHIFT(231),    
        [ts_aux_sym_token9] = SHIFT(57),    
        [ts_builtin_sym_error] = SHIFT(235),
    },
    
    [208] = {    
        [ts_aux_sym_token1] = SHIFT(209),
    },
    ...
    [294] = {    
        ...
        [ts_aux_sym_token3] = SHIFT(316),    
        [ts_aux_sym_token9] = SHIFT(57),    
        [ts_builtin_sym_error] = SHIFT(320),
    },
    
    [295] = {    
        [ts_aux_sym_token1] = SHIFT(296),
    },
