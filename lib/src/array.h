...
static inline void _array__erase(ArrayMeta *self_meta, void *self_contents, size_t element_size,
                                uint32_t index) {
  ts_assert(index < self_meta->size);
...
static inline void *_array__reserve(ArrayMeta *self_meta, void *self_contents, size_t element_size, uint32_t new_capacity) {
...
static inline void* _array__assign(ArrayMeta *self_meta, void *self_contents, const ArrayMeta *other_meta, const void *other_contents, size_t element_size) {
...
static inline void *_array__grow(ArrayMeta *self_meta, void *self_contents, uint32_t count, size_t element_size) {
...
static inline void* _array__splice(ArrayMeta *self_meta, void *self_contents, size_t element_size,
                                 uint32_t index, uint32_t old_count,
                                 uint32_t new_count, const void *elements) {
  uint32_t new_size = self_meta->size + new_count - old_count;
  uint32_t old_end = index + old_count;
  uint32_t new_end = index + new_count;
  ts_assert(old_end <= self_meta->size);
