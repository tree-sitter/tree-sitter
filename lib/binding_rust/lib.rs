...
impl<'a> From<&'a InputEdit> for ffi::TSInputEdit {
    fn from(input_edit: &'a InputEdit) -> Self {
        Self {
            start_byte: input_edit.start_byte as u32,
            old_end_byte: input_edit.old_end_byte as u32,
            new_end_byte: input_edit.new_end_byte as u32,
            start_point: input_edit.start_position.into(),
            old_end_point: input_edit.old_end_position.into(),
            new_end_point: input_edit.new_end_position.into(),
        }
    }
}
