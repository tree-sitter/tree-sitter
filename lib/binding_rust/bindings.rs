...
extern "C" {
    pub fn ts_node_string_extra(arg1: TSNode) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    #[doc = " Get a string representing any diagnostics on the node. It returns NULL"]
    #[doc = " if no diagnostics are found."]
    #[doc = ""]
    #[doc = " This string is allocated with `malloc` and the caller is responsible for"]
    #[doc = " freeing it using `free`."]
    pub fn ts_node_string_diagnostics(arg1: TSNode) -> *mut ::std::os::raw::c_char;
}
extern "C" {
