...
extern "C" {
    #[doc = " Get appendable file descriptor for Dot Graph output."]
    pub fn ts_dot_graph_io_get_appendable_fd(fd: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
extern "C" {
    #[doc = " Get appendable file descriptor for Dot Graph output.\n Windows version uses in file handle."]
    pub fn ts_dot_graph_io_get_appendable_fd_win(osfhandle: isize) -> ::std::os::raw::c_int;
}
