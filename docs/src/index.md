...
- [Elisp (`tree-sitter.el`)](https://github.com/emacs-tree-sitter/elisp-tree-sitter)
- [Elisp (`treesit.el`)](https://www.gnu.org/software/emacs/manual/html_node/elisp/Parsing-Program-Source.html)
